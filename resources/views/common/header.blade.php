                ...
                <div class="row">
                    <div class="col-md-12 p-0">
                        <nav class="navbar fixed-top navbar-expand-lg navbar-toggleable-sm navbar-light bg-white">
                            ...
                            <button class="navbar-toggler navbar-toggler-right collapsed" id="toggle" type="button" data-toggle="collapse" data-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
                                    <span> </span>
                                    <span> </span>
                                    <span> </span>
                                </button>
                            ...
                            <div class="collapse navbar-collapse modile-hide mobile-view-hide" id="asnavsupportcontent">
                                ...
                                <ul class="navbar-nav right-nav ml-auto mr-3">
                                    ...
                                    <li class="nav-item">
                                        <a class="trans-btn" href="#">Agent Login</a>
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="right-link dropdown-toggle" href="http://example.com" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                           ...
                                           <div class="dropdown-menu filter-widget-inner-drop-list home-flag-nav" aria-labelledby="dropdown09">

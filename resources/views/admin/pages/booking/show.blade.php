                    ...
                    <div class="col-md-6">
                        <div class="d-flex align-items-center border-bottom">
                            <p class="d-flex flex-column">
                                ...
                                <span
                                    class="text-muted">{{ $record->user && $record->user->name ? $record->user->name : 'Guest' }}</span>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        @if(!isset($record->occupants) || count($record->occupants) < 1)
                            @include('admin.common.alerts.infoNoRecords') @else <table
                            ...
                            <tbody>
                                ...
                                <tr id="type_{{ $occupant->id }}">
                                    ...
                                    <td>
                                        <a
                                            href="{{ route('booking.show', ['booking' => $record->id, 'occupant' => $occupant->id]) }}">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <div class="btn btn-tool">
                        <a href="{{ route('booking.show', ['booking' => $record->id]) }}"><i class="fas fa-list"></i>
                            List</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="d-flex align-items-center border-bottom mb-3">
                            ...
                            && isset($occupant->identity->files->first()->url))
                                ...
                                @if(strpos($occupant->identity->files->first()->url, 'jpeg') !== false

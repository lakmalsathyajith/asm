                    ...
                    <div class="row listing-wrap">
                        <div class="col-md-8 p-0">
                            ...
                            <div class="bottom-desc-behind-wrap">
                                <h3>Apartment 404</h3>
                                <p><span class="ti-location-pin"></span> Elizabeth Street Melbourne</p>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="apartment-inner-left-wrap">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="dropdown filter-widget">
                                                ...
                                                <div class="dropdown-menu filter-widget-dropdown" aria-labelledby="dropdownMenuButton" x-placement="bottom-start">
                                        ...
                                        <div class="form-group">
                                            <div class="dropdown filter-widget">
                                                <label for="checkin" class="filter-widget-sublabel">Check-Out</label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 filter-widget-col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input data-date-format="mm-dd-yyyy" type="text" class="form-control datepicker asm-input date" placeholder="Check Out" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="dropdown filter-widget">
                                                <label for="checkin" class="filter-widget-sublabel">Occupants</label>

                                                <button class="btn dropdown-toggle flter-button" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="ti-location-pin"></i><span> 2 Adults</span>
                                                </button>
                                                <div class="dropdown-menu filter-widget-dropdown" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" >
                                                    <div class="filter-widget-inner">
                                                        <div class="row">
                                                            <div class="col-md-12 filter-widget-col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="checkin" type="text" class="form-control asm-input" placeholder="Adults">
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="dropdown filter-widget">
                                                <label for="checkin" class="filter-widget-sublabel"></label>

                                                <button class="btn dropdown-toggle flter-button" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="ti-location-pin"></i><span>Children(s)</span>
                                                </button>
                                                <div class="dropdown-menu filter-widget-dropdown" aria-labelledby="dropdownMenuButton" x-placement="bottom-start">
                                                    <div class="filter-widget-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 filter-widget-col">
                                                                <div class="form-group">
                                                                    <label for="checkout" class="filter-widget-sublabel"> Children(s)</label>
                                                                    <input id="checkout" type="text" class="form-control asm-input" placeholder="1 Children(s)">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="dropdown filter-widget">
                                                <label for="checkin" class="filter-widget-sublabel">Beds</label>

                                                <button class="btn dropdown-toggle flter-button" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="ti-location-pin"></i><span> 1-2 Beds</span>
                                                </button>
                                                <div class="dropdown-menu filter-widget-dropdown" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 40px, 0px);">
                                                    <div class="filter-widget-inner">
                                                        <div class="row">
                                                            <div class="col-md-12 filter-widget-col">
                                                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="filter-widget">
                                                <a href="/booking-first" class="btn booking-btn">Book Now</a>
                                            </div>
                            ...
                            <!-- <div class="row">
                            <div class="col-md-12">
                                <div class="save-shortlist">
                                    <a class="btn shortlist"><i class="ti-tag"></i> Save to shortlist</a>
                                </div>
                            </div>
                        </div> -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="location-wrap">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3152.9152599587233!2d144.9688474150612!3d-37.792025640572405!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad64328b4fb4173%3A0xfa2430a470c7cef7!2s567%20Rathdowne%20St%2C%20Carlton%20North%20VIC%203054%2C%20Australia!5e0!3m2!1sen!2slk!4v1572983683592!5m2!1sen!2slk" width="100%" height="342" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="details-para">
                                <p class="inner-apart-para">Beautiful newly re-furnished studio apartment in the heart of the CBD
                                    <br> and Melbourne’s financial / business district.</p>
                            </div>

                            <div class="list-minute">
                                <ul>
                                    <li>5 minutes to RMIT</li>
                                    <li>9 minutes to Melbourne University</li>
                                    <li>200 m to Flinders Street Station</li>
                                    <li>Heart of Business District </li>
                                    <li>You will have sole occupancy of the Apartment that you book </li>

                                </ul>
                            </div>

                            <div class="details-para details-para-bottom">
                                <p class="inner-apart-para">Security access to building foyer / lobby.
                                    <br> To make an enquiry, inspect or secure your booking, call our
                                    <br>reservations team or enquire online today.</p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="Bedding-wrap-content">
                                ...
                                <ul class="main-options">
                                    ...
                                    <li>
                                        <span class="main-option-li">Bedroom 1</span>

<template>
 ...
 <section class="top-search-wrap padding-tb-60 ">
              ...
              <div class="col-md-12">
                <div class="nav-top-path">
                  <ul class="list-inline">
                    ...
                    <li class="list-inline-item navigation-path-name">
                      <a href="/typical-apartment">...</a>
                      <span class="navigation-path">></span>
                    </li>
                    <li class="list-inline-item">
                      <span class="current-page">booking</span>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <!--mobile nav -->
      <div class="desktop-hide mobi-nav filter-mobi-nav desktop-hide">
        <div
        ...
        >
          <div class="container">
            <div class="top-mob-nav">
              <div class="top-nav-wrap summery-top-close-nav">
                <div class="row">
                  <div class="col-6">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="booking-right-side-middle-wrap">
                      ...
                      <div class="bottom-rent-details-wrap">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="divider mobile-total-devide"></div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-6">
                        ...
                        <div class="agreement-wrap mobile-top-agreement-wrap">
                          <div class="row">
                            <div class="col-md-12">
                      ...
                      <div class="col-12 p-0">
                        <div class="form-group">
                          <div class="filter-widget">
                            <a class="btn booking-btn">Pay $1,668 Now</a>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <div class="container-fluid mobile-filter-top-wrap-full booking-summery-wrap tab-hide desktop-hide">
        <div class="mobile-filter-top-wrap">
          <div class="container">
            <div class="row">
              <div class="col-8 p-0">
                <div class="apartment-top-details-wrap">
                  <ul class="list-inline">
                    <li class="list-inline-item">
                      <img src="images/aptment-01.png" alt="top-list" width="72px" height="48px" />
                    </li>
                    <li class="list-inline-item price-list-li">
                      <div class="mobile-top-total">
                        <h4>Total Price</h4>
                      </div>
                      <div class="mobile-top-amount">
                        <h2>$1,620.00</h2>
                      </div>
                    </li>
                  </ul>
              ...
              <div class="col-4 p-0">
                <div class="form-group">
                  <div class="dropdown filter-widget">
                    <button
                      class="btn dropdown-toggle flter-button top-summery-button"
                      type="button"
                      id="filter-toggle"
    ...
    <section class="third-booking-section">
        <div class="container-fluid">
            <div class="row">
            ...
            <div class="row">
                <div class="container">
                    <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label radio-label-work inputradio-check-lable" for="inlineRadio1">Credit Card</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input student-info-radio" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">
                                                <label class="form-check-label radio-label-student inputradio-check-lable" for="inlineRadio2">Direct bank transfer</label>
                                            </div>
                                        </div>
                            ...
                            <div class="booking-form-step2-wrap">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="dropdown filter-widget">
                                                <label for="checkin" class="filter-widget-sublabel">Credit Card Number* </label>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="dropdown filter-widget">
                                                        <label for="checkin" class="filter-widget-sublabel">Expire* </label>
                                                        <input class="form-control flter-button" type="text">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="dropdown filter-widget">
                                                <label for="checkin" class="filter-widget-sublabel">Security Code* </label>
                                                <input class="form-control flter-button" type="text">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="dropdown filter-widget">
                                                <label for="checkin" class="filter-widget-sublabel">Cardholder Name* </label>
                                                <input class="form-control flter-button" type="text">
                        ...
                        <div class="col-md-4 modile-hide tab-view">
                            <div class="booking-right-side-top-wrap">

                      ...
                      <div class="form-group">
                        <div class="dropdown filter-widget">
                          ...
                          >
                            ...
                            >
                              <a class="dropdown-item" href="#." v-on:click="selectType('studio-apartments')"
                                >Studio Apartments</a
                              >
                              <a class="dropdown-item" href="#." v-on:click="selectType('one-bed-room-apartments')"
                                >One Bedroom Apartments</a
                              >
                              <a class="dropdown-item" href="#." v-on:click="selectType('two-bed-room-apartments')"
                      ...
                      <div class="form-group">
                        <div class="dropdown">
                          <button
                            ...
                            aria-expanded="false"
                          >
                            <i class="ti-calendar"></i> Check-In/Out
                          </button>
                          <div
                            class="dropdown-menu"
                            aria-labelledby="dropdownMenuButton"
                                  ...
                                  <div class="col-md-6 filter-widget-col">
                                    <div class="form-group">
                                      ...
                                      <input
                                        ...
                                        type="text"
                                        class="form-control datepicker asm-input date"
                                        placeholder="Check In"
                                      />
                                    </div>
                                  </div>
                      ...
                      <div class="form-group">
                        <div class="dropdown">
                          <button
                            ...
                            aria-expanded="false"
                          >
                            <i class="ti-calendar"></i> Beds: Min/Max
                          </button>
                          <div
                            class="dropdown-menu"
                            aria-labelledby="dropdownMenuButton"
                      ...
                      <div class="form-group">
                        <div class="dropdown">
                          <button
                            ...
                            aria-expanded="false"
                          >
                            <i class="ti-calendar"></i> Price: Min/Max
                          </button>
                          <div
                            class="dropdown-menu"
                            aria-labelledby="dropdownMenuButton"
              ...
              <div class="welcome-para">
                ...
                <div class="welcome-para3">
                  ...
                  >For the discerning international student who is seeking style and space our apartments offer everything a student apartment doesn’t. Our apartments are two to three times larger than a typical student apartment, stylishly appointed with everything you will need to make you feel like you have never left home.</p>
                    ...
                    <p class="paraf">Apartment Stays Melbourne provides a number of different furnished apartment configurations to suit all needs. Studios, One and Two Bedrooms and are therefore ideally suited for the business traveller, academics, students, professionals, long term travellers, families and others simply in the need for medium to long term accommodation.</p>
                    <p class="paraf">We offer a variety of solutions to cater for differing needs. Building quality, apartment quality, size, apartment amenities and building facilities all determine the category we attribute to each apartment.</p>
                    <p class="paraf">
    ...
    <section class="reviews padding-tb-60">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div id="apartment-review-Indicators" class="carousel slide" data-ride="carousel" data-interval="5000" data-pause="true">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5>Zac</h5>
                           <p class="paraf-small">Great place, outstanding location and amazing communication</p>
                     ...
                     <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">Li-Ren</h5>
                           <p class="paraf-small">Great location to wonder around the Melbourne CBD. Clean and comfortable. Easy to check in and super friendly and helpful staff. Would definitely stay again next time.</p>
                      ...
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">Angela</h5>
                           <p class="paraf-small">Location is fabulous. Can get free tram or catch the multitude of transport to anywhere you want. Everything we needed for our 12 month stay was provided. We didn’t need to buy anything for the apartment. Bed was super comfy and our floor was quiet. We slept really well.</p>
                      ...
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">Wei</h5>
                           <p class="paraf-small">Spacious and clean, exactly what I was after. Safe building in lovely area and perfect for walking to work and uni. Would definitely stay again next year.</p>
                      ...
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">David</h5>
                           <p class="paraf-small">Really nice space in a fantastic location, with appliances, kitchen tools, perfect. The apartment is a great size with lots of Northern light. Just over 7 months in Melbourne, this place was perfect.</p>
                      ...
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">Julie</h5>
                           <p class="paraf-small">reat location, convenient and very easy to check in. We're happy with the amenities and communication. The furniture was so nice and we loved the huge TV. Internet was superfast. The kitchen had more than what we expected. We both enjoy our stay in Melbourne! We would love to come back again.</p>
                      ...
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">Cherry</h5>
                           <p class="paraf-small">The Apartment Stays team were amazing. Nice and friendly staff, fast response and kind to us. A great place to stay.</p>
                      ...
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">Nicholas</h5>
                           <p class="paraf-small">Stylish and comfortable accommodation right in the middle of South Yarra. Amazing location, close to cafes, restaurants, train station, tram, Botanic Gardens etc 25 minutes to Monash Uni. Would highly recommend compared to living in Clayton – nothing to do there</p>
                      ...
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">Kylie</h5>
                           <p class="paraf-small">You can expect a beautiful apartment in a fabulous location. All the amenities were stunning and lots of cooking appliances and cooking tools. The bed was soooo comfortable and loved that I couldn't feel it when my hubby moved and vice versa. Shower was great with amazing hot water system. All in all a beautiful apartment, very comfortable and easy access to shops, trams, restaurants, cafes etc. Perfect location. Would definitely stay there again. Nicky went above and beyond to accommodate us as I had just had major surgery and she was so helpful in allowing us easy check-in and check out. This is your place to stay. Superb.</p>
                      ...
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">Aser</h5>
                           <p class="paraf-small">Such a great place in a stunning location, all new/refurbished interiors and utilities. The studio is actually a really great space. The furniture is contemporary and obviously brand new. The hospitality of the hosts is 5 star and I just wish I could stay there forever.</p>
                      ...
                      <div class="person-content-box text-center">
                        ...
                        <div class="person-content">
                          <h5 class="paraf">Somasekhar</h5>
                           <p class="paraf-small">Central location on Spring Street. Apartment on ground floor (no lifts or stairs). Large & spacious. I was drawn to the ground floor garden with my own private BBQ. The building facilities are truly resort like. My partner and I even played the odd game of tennis. The Apartment Stays team are responsive attentive hosts. Very happy to recommend this apartment. Thank you.</p>

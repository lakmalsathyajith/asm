      ...
      <div class="top-slider-wrap">
        ...
        <div class="swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide home-slide slide1">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
            ...
            <div class="swiper-slide home-slide slide2">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <div class="d-table w-100 h-100">
            ...
            <div class="swiper-slide home-slide slide3">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <div class="d-table w-100 h-100">
            ...
            <div class="swiper-slide home-slide slide4">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <div class="d-table w-100 h-100">
        ...
        <section class="booking-form-section">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <form>
                  <div class="desktop-home-filter mobile-only modile-hide tab-view">
                    <div class="row">
                      <div class="col">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            >
              ...
              <a
                class="carousel-control-prev modile-hide"
              ...
              <a
                class="carousel-control-next modile-hide"
                href="#apartment-review-Indicators"
                role="button"
                data-slide="next"
              >
              ...
              <ol class="carousel-indicators">
                ...
                <li data-target="#apartment-review-Indicators" data-slide-to="14"></li>
                <li data-target="#apartment-review-Indicators" data-slide-to="15"></li>
                <li data-target="#apartment-review-Indicators" data-slide-to="16"></li>
                <li data-target="#apartment-review-Indicators" data-slide-to="17"></li>
              </ol>
            </div>
          </div>
        </div>
